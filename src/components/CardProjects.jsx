...
<div className="flex justify-end mb-5">
  <Link
href={link} className="text-violet-600 focus:ring-4 focus:outline-none  font-medium cursor-pointer hover:scale-110 font-mooli w-1/2 h-auto flex items-center justify-center">Visita Pagina &rarr;</Link>
    </div>
    </div>
